  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        ...
        <div class="card">
          <div class="card-body">
            <form method="POST" action="<?php echo base_url('') . 'index.php/Perpustakaan/update'; ?>" enctype="multipart/form-data">
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="deskripsi" class="form-control"  value="<?php echo $all_data['deskripsi']; ?>" required>
              </div>
