    ...
    <div class="card-body p-4">
      ...
      <div class="row">
        ...
        <div class="col-2" style="text-align: right;">
          <a class="btn btn-primary m-1" href="<?php echo base_url('') . 'index.php/Buku/tambah'; ?>">
            <span>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;">
                <a class="btn btn-dark m-1" href="<?php echo base_url('') . 'index.php/Buku/edit/' . $row['id']; ?>">
                  <span>
                    <i class="ti ti-edit"></i>
                  </span>
                </a>
                <a class="btn btn-light m-1" href="<?php echo base_url('') . 'index.php/Buku/delete/' . $row['id']; ?>">
                  <span>
