...
<html>
	<head>
		<title>Absensi PJT 1 - Page Notfound</title>
        <link rel="icon" href="https://eproc.jasatirta1.co.id/eproc_front/assets/images/LOGO3.png">
        <style>
	...
	<body class="permission_denied">
		...
		<div class="denied__wrapper">
			...
			<svg id="planet" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 270px;margin-left: 55px;">
